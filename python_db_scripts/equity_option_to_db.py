...
def get_symbol_table_map():
    symbol_tables = {}
    symbol_tables['AAPL'] = 'iv_recorder_aapl'
    symbol_tables['AMZN'] = 'iv_recorder_amzn'
    symbol_tables['MSFT'] = 'iv_recorder_msft'
    symbol_tables['META'] = 'iv_recorder_meta'
    symbol_tables['SPY'] = 'iv_recorder_spy'
    symbol_tables['QQQ'] = 'iv_recorder_qqq'
    symbol_tables['TSLA'] = 'iv_recorder_tsla'
...
def RunLive(redis_files_key, live_table):
    ...
    while True:
        try:
            ...
            print('EQUITY RunLive: Read redis key {} Error {}'.format(files_key, ex))
            continue
        ...
        try:
            ...
            print('EQUITY RunLive: Read file {}  and write to table {}.{} Error {}'.format(filename, db_config['db'], to_table, ex))
            continue
...
if __name__ == '__main__':
    ...
    if args.Key:
        ...
        exit()
    if args.Live:
        live_table = 'iv_live_ML'
        print('Equity Options: save to live table {}'.format(live_table))
        RunLive(rd_filekey, live_table)
    elif args.Backup:
        print('Equity Options: backup to historical data tables')
